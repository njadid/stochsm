...
#PBS -l mem=16gb                # memory per core
...
/bin/echo month $1
python /storage/coda1/p-rbras6/0/njadidoleslam3/projects/stochsm/stage4_analysis/events_monthly_based/st4_analysis_monthly.py $1