...
#####
pickle_fmt = '/storage/coda1/p-rbras6/0/njadidoleslam3/projects/stochsm/persiann_analysis/events_mbased/monthly/{month}.pickle'
in_pick_fmt = '/storage/coda1/p-rbras6/0/njadidoleslam3/projects/stochsm/persiann_analysis/events_mbased/yearly/{year}.pickle'
