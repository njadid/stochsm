...
#PBS -l mem=32gb                # memory per core
#PBS -l walltime=30:00:00      # duration of the job (ex: 15 min)
...
/bin/echo year $1
python /storage/coda1/p-rbras6/0/njadidoleslam3/projects/stochsm/gpm_analysis/scripts/gpm_events.py $1