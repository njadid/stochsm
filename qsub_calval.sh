...
#PBS -l walltime=100:00:00      # duration of the job (ex: 15 min)
#PBS -j oe                      # combine output and error messages into 1 file
#PBS -o calval.out      # output file name
...
# /bin/echo year $1
python /storage/home/hcoda1/6/njadidoleslam3/p-rbras6-0/projects/stochsm/get_calval_site_GPM.py