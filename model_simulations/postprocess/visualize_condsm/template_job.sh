...
#PBS -l mem=40gb                # memory per core
#PBS -l walltime=04:30:00      # duration of the job (ex: 15 min)
...
python /storage/coda1/p-rbras6/0/njadidoleslam3/projects/stochsm/model_simulations/postprocess/visualize_condsm/visualize_monthly_based_v1.py $1