...
#PBS -l mem=3gb                # memory per core
#PBS -l walltime=15:00:00      # duration of the job (ex: 15 min)
...
python /storage/coda1/p-rbras6/0/njadidoleslam3/projects/stochsm/model_simulations/model_run_mp.py $1